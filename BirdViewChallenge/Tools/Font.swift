...
struct Font {
    ...
    // Tools.font.sFProTextBlack(size: <#입력#>)
    func sFProTextBlack(size: CGFloat) -> UIFont {
        return UIFont.init(name: "SFProText-Black", size: size) ?? UIFont.systemFont(ofSize: size)
    }
}
